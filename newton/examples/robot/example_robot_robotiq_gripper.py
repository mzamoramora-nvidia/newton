...
###########################################################################
# Example Robot Robotiq Gripper
#
# Shows how to set up a simulation of a Robotiq Gripper with fixed tendons.
# The Robotiq Gripper is a 2-finger gripper with a fixed tendon.
#
# This example demonstrates:
# - Loading a MuJoCo model with fixed tendons via MJCF
# - Multi-world simulation with tendon support
#
# Command: python -m newton.examples robot_robotiq_gripper --num-worlds 4
#
###########################################################################
...
class Example:
    def __init__(self, viewer, num_worlds=4, args=None):
        ...
        self.base_joint_enabled = False
        self.base_joint_str = "px,py,pz,rx,ry,rz"
        self.base_joint_names = self.base_joint_str.split(",")
        self.base_joint_dofs = len(self.base_joint_names) if self.base_joint_enabled else 0
        ...
        self.mjc_ctrl_source = self.solver.mjc_actuator_ctrl_source.numpy()
        self.mjc_to_newton = self.solver.mjc_actuator_to_newton_idx.numpy()
    ...
    def build_robotiq_2f85(self):
        ...
        robotiq_2f85.add_mjcf(
            robotiq_2f85_path,
            xform=xform,
            base_joint=self.base_joint_str if self.base_joint_enabled else None,
