...
class Example:
    ...
    def load_model(self):
        ...
        # Add wheel
        scene.add_joint_free(parent=-1, child=object_id)
    ...
    def simulate(self):
        ...
        for i in range(self.sim_substeps):
            ...
            hydroelastic_isosurface.compute_contact_surfaces_and_wrenches(
                ...
                update_contact_pairs=(i % 25 == 0 or i == self.sim_substeps - 1),
            )
