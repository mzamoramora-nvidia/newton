...
- Add `HydroelasticSDF.Config.stiffness_mapping` to opt hydroelastic MuJoCo contacts into mass-normalized force-space stiffness conversion while preserving the raw mapping by default.
